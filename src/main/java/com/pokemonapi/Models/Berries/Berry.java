...
public class Berry extends NamedAPIResource {
	...
	// A list of references to each flavor a berry can have and the potency of each
	// of those flavors in regard to this berry.
	private ArrayList<BerryFlavorMap> flavors;

	// Berries are actually items. This is a reference to the item specific data for
	// this berry.
	private Item item;
