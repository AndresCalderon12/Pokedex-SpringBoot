...
import com.pokemonapi.Models.contests.ContestEffect;
import com.pokemonapi.Models.contests.ContestType;
import com.pokemonapi.Models.contests.SuperContestEffect;
import com.pokemonapi.Models.games.Generation;
import com.pokemonapi.Models.pokemon.AbilityEffectChange;
...
public class Move extends NamedAPIResource {
	...
	// battle. See Bulbapedia for greater detail.
	...
	// The list of previous effects this move has had across version groups of the
	// games.
