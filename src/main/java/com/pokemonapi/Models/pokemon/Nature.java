...
import com.pokemonapi.Models.Berries.BerryFlavor;
...
public class Nature extends NamedAPIResource {
	...
	// A list of battle styles and how likely a Pokémon with this nature is to use
	// them in the Battle Palace or Battle Tent.
