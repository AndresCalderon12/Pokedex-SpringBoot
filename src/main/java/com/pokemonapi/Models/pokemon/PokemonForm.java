...
public class PokemonForm extends NamedAPIResource {
	...
	// may have equal order, in which case they should fall back on sorting by name.
	private int order;
	...
	// The form specific full name of this Pokémon form, or empty if the form does
	// not have a specific name.
	private ArrayList<Name> names;

	// The form specific form name of this Pokémon form, or empty if the form does
	// not have a specific name.
